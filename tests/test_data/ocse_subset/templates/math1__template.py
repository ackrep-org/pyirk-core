...
insert_entities = [
    ...
    raw__I9906["square matrix"].set_relation(p.R37["has definition"], I9907["definition of square matrix"]),
    I6259["sequence"],
    ...
    def__I6324_cc_pp,
    raw__I6324["canonical first order monic polynomial matrix"].add_method(
